...
export async function onRequestGet(context){
 ...
 try{
  ...
  return json({ok:true,build:"v79",season,teams:teams.results||[],scheduled:scheduled.results||[],completed:completed.results||[],captain_availability,actor_email:context.data.actorEmail||null});
